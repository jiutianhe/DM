...
public final class RecommendFactory {
    ...
    public static UserSimilarity userSimilarity(SimilarityType type, DataModel m) throws TasteException {
        switch (type) {
        case PEARSON:
    ...
    public static ItemSimilarity itemSimilarity(SimilarityType type, DataModel m) throws TasteException {
        switch (type) {
        case PEARSON:
            return new PearsonCorrelationSimilarity(m);
        case COSINE:
    ...
    public static UserNeighborhood userNeighborhood(NeighborhoodType type, UserSimilarity s, DataModel m, double num) throws TasteException {
        switch (type) {
        case NEAREST:
